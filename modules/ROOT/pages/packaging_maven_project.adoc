...
build failure due to xref:common_errors.adoc#error_missing_dependency[missing dependencies]
...
`pom.xml` files. See xref:pom_macros.adoc#helper_macros[Macros for POM
modification] section for more information.
