...
the first time start reading xref:introduction_for_developers.adoc#XFor_Devs[Java developer]
section. On the other hand if you are coming from RPM packaging background an
xref:introduction_for_packagers.adoc#XFor_Packagers[introduction to Java world]
