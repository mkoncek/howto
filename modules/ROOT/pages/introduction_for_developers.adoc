...
Header, which contains: ::
   ...
   ** More information on this topic can be found in
      xref:dependency_handling.adoc#dependency_handling[Dependency
      handling] section.
...
alias for same JAR file. See section about xref:jar_file_id_aliases.adoc#aliases[artifact aliases] for more information on this topic.
